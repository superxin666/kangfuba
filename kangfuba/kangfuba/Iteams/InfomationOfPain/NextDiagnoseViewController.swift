//
//  NextDiagnoseViewController.swift
//  kangfuba
//
//  Created by LiChuanmin on 2016/11/7.
...
class NextDiagnoseViewController: BaseViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    var postDic:Dictionary<String,Int> = ["初始化":0]//最后上传的字典-上个页面传来的
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        if section==0 {
            ...
            if self.dataModel.datas.count>0 {
                let model = self.dataModel.datas[indexTest]
    ...
    func createHeadView() -> UIView {
        ...
        let tempModel1 = self.dataModel.datas[indexTest]
        
        if (tempModel1.guidevideo != nil) {
            doctorVideoUrlString = tempModel1.guidevideo
        }
        ...
        if self.dataModel.datas.count>indexTest {
            let tempModel = self.dataModel.datas[indexTest]
    ...
    func helpTapClick(tapGesture:UITapGestureRecognizer) {
        ...
        self.tempHelpModel = self.dataModel.datas[indexTest]
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if indexPath.section > 0 {
            ...
            if (detailInguryTempModel.isSelect == 1) {
                ...
                self.dataModel.datas[indexTest].Bmenu[indexPath.row].isSelect = 1
